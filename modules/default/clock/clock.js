	...
	getDom () {
		...
		if (this.config.showSunTimes) {
			...
			sunWrapper.innerHTML
				= `<span class="${isVisible ? "bright" : ""}"><i class="fa-sharp-duotone fa-thin fa-sun fa-beat fa-lg" style="--fa-primary-color: #ffc800; --fa-secondary-color: #ffc800; --fa-secondary-opacity: 0.8;"></i>`
